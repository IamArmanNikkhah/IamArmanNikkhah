...
### 🔬 Research Interests
- Ultra‑low‑latency WebRTC & RTP pipelines for AR/VR
- 360° video entropy & Bayesian surprise modeling
- Hybrid VAE‑LSTM architectures for spatial audio prediction
- Reinforcement learning for adaptive bitrate (ABR) in 360° streaming
- Cross‑modal perception & synesthesia in AI systems
- Agentic AI frameworks for scientific discovery
...
### 🎯 Goals & Values
I believe in **open research**, reproducibility, and the power of interdisciplinary collaboration. Much of my work is open‑sourced here to accelerate innovation in immersive media and AI.

### 🤝 Get In Touch
- 📧 **Email:** arman.nikkhah@example.com
- 👨‍🏢 **LinkedIn:** [linkedin.com/in/arman-nik-khah](https://linkedin.com/in/arman-nik-khah)
- 🐦 **Twitter:** [@arman_nikkhah](https://twitter.com/arman_nikkhah)

I’m always excited to connect with fellow researchers and developers—feel free to reach out if you'd like to collaborate or chat about immersive media!
